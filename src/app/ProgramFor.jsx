...
const ProgramFor = () => {
  return (
    <div
      id="product"
      className="flex flex-col items-center w-full  pb-[90px] md:pb-[50px] px-[24px] md:px-[32px] xl:px-[152px] gap-[80px] relative"
    >
          ...
          <div className="w-full flex flex-col md:flex-row gap-6 md:gap-10 xl:max-w-min ">
            ...
            >
              <div className="w-32 aspect-square rounded-full relative flex justify-center items-center animate-[spin_3s_linear_infinite] z-40 bg-[conic-gradient(white_0deg,white_300deg,transparent_270deg,transparent_360deg)] before:animate-[spin_2s_linear_infinite] before:absolute before:w-[60%] before:aspect-square before:rounded-full before:z-[80] before:bg-[conic-gradient(white_0deg,white_270deg,transparent_180deg,transparent_360deg)] after:absolute after:w-3/4 after:aspect-square after:rounded-full after:z-[60] after:animate-[spin_3s_linear_infinite] after:bg-[conic-gradient(#a61313_0deg,#a61313_180deg,transparent_180deg,transparent_360deg)]">
                <span className="absolute w-[85%] aspect-square rounded-full z-[60] animate-[spin_5s_linear_infinite] bg-[conic-gradient(#f87171_0deg,#f87171_180deg,transparent_180deg,transparent_360deg)]"></span>
              </div>

              <div className="w-full flex flex-col items-center md:items-start gap-1 md:gap-2">
                <h3 className="font-medium text-[24px] leading-[28.8px] tracking-[-1px] text-black">
                Grade 12th Pass Student
                </h3>
              </div>
            </motion.div>
            <motion.div
